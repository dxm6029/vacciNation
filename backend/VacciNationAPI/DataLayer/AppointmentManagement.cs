    ...
    public class AppointmentManagement {
        ...
        public int updateTimeslotCitizenDose(Timeslot timeslot, int vaccineType){
            ...
            try{
                ...
                string updateSlot = "UPDATE timeslot SET dose_id=(SELECT dose_id FROM dose LEFT JOIN timeslot WHERE vaccine_id=@vaccine_id AND timeslot_id IS NULL LIMIT 1) resdose, citizen_id=@citizen_id, status=@statusNum WHERE timeslot_id=@timeslot_id AND resdose IS NOT NULL";
