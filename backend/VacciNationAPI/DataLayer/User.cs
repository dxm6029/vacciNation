    ...
    public class User {
        ...
        public List<Staff> getAllStaff(){
            ...
            try{ 
                ...
                string query = "SELECT staff_id, email, username, last_name, first_name, role.name FROM staff JOIN staff_role ON staff_role.staff_id=staff.staff_id JOIN role ON user_role.role_id=role.role_id";
                MySqlCommand cmd = new MySqlCommand(query, conn);
